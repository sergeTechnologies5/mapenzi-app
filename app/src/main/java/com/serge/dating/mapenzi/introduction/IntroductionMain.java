package com.serge.dating.mapenzi.introduction;
...
import com.serge.dating.mapenzi.Login.Login;
...
public class IntroductionMain extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mAuth.getCurrentUser()!=null){
            startActivity(new Intent(IntroductionMain.this, MainActivity.class));
            finish();
        }
        signUpButton = findViewById(R.id.signup_button);

        signUpButton.setOnClickListener(v -> openEmailAddressEntryPage());
